...
function library:tween(instance: Instance, info: TweenInfo, props: {[string]: any})
	TweenService:Create(instance, info, props):Play()
end

function library:create(class: string, props: {[string]: any}, parent: Instance?): Instance
...
function library.new(library_title, cfg_location)
	...
	local ScreenGui = library:create("ScreenGui", {
		...
		Name = "UI_" .. HttpService:GenerateGUID(false):sub(1, 8),
		IgnoreGuiInset = true,
	})
				...
				function sector.element(type, text, data, callback, c_flag)
					...
					elseif type == "Slider" then
						...
						SliderButton.MouseButton1Down:Connect(function()
							...
							release_connection = UserInputService.InputEnded:Connect(function(input)
...
local function createLoader()
	local gui = library:create("ScreenGui", {
		Name = "Auth_" .. HttpService:GenerateGUID(false):sub(1, 8),
		ResetOnSpawn = false,
		ZIndexBehavior = Enum.ZIndexBehavior.Global,
	}, playerGui)
	...
	library:set_draggable(main)
	library:create("UICorner", {CornerRadius = UDim.new(0, 4)}, main)
	...
	local usernameFrame = library:create("Frame", {
		BackgroundColor3 = Color3.fromRGB(20, 20, 20),
		BorderSizePixel = 0,
		Position = UDim2.new(0.5, -150, 0, 100),
		Size = UDim2.new(0, 300, 0, 35),
	}, main)
	library:create("UICorner", {CornerRadius = UDim.new(0, 4)}, usernameFrame)
	
	local usernameBox = library:create("TextBox", {
		BackgroundTransparency = 1,
	...
	local passwordFrame = library:create("Frame", {
		BackgroundColor3 = Color3.fromRGB(20, 20, 20),
		BorderSizePixel = 0,
		Position = UDim2.new(0.5, -150, 0, 150),
		Size = UDim2.new(0, 300, 0, 35),
	}, main)
	library:create("UICorner", {CornerRadius = UDim.new(0, 4)}, passwordFrame)
	
	local passwordBox = library:create("TextBox", {
		BackgroundTransparency = 1,
		Position = UDim2.new(0, 10, 0, 0),
	...
	local loginBtn = library:create("TextButton", {
		AnchorPoint = Vector2.new(0.5, 0),
	...
	library:create("UICorner", {CornerRadius = UDim.new(0, 4)}, loginBtn)
	...
	local loading = library:create("Frame", {
		BackgroundTransparency = 1,
		Position = UDim2.new(0.5, -50, 0, 280),
		Size = UDim2.new(0, 100, 0, 30),
		Visible = false,
	}, main)
	
	local loadText = library:create("TextLabel", {
		BackgroundTransparency = 1,
		Size = UDim2.new(1, 0, 1, 0),
		Font = Enum.Font.GothamBold,
		Text = "LOADING",
	...
	loginBtn.MouseEnter:Connect(function()
		library:tween(loginBtn, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(94, 111, 255)})
	end)
	
	loginBtn.MouseLeave:Connect(function()
		library:tween(loginBtn, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(84, 101, 255)})
	end)
	...
	local function authenticate()
		...
		if user == USERNAME and pass == PASSWORD then
			...
			task.delay(1.5, function()
				...
				local menu = library.new("Private Script", "Configs")
